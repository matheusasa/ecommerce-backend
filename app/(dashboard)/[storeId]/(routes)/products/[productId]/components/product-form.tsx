...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const description = initialData ? 'Editar um produto.' : 'Adicionar um produto';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Tenha certeza que voce removeu todas as categorias desse billboard.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Esse produto vai aparecer na homepage
                    </FormDescription>
                  </div>
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Esse produto não vai aparecer na homepage
                    </FormDescription>
                  </div>
                </FormItem>
              )}
